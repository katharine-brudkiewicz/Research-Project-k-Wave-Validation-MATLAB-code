...
clearvars;
%%%%%%%%%%%%%% Simulation 1 - Planar Piston Non Attenuated Homogenoeus %%
% =========================================================================
% DEFINE LITERALS
% =========================================================================
...
%% Variables %%
m=41; % defines planar piston resolution
a=0.01; % piston radius
w = 311; % computational grid size
...
imagesc(x2*1e3,y2*1e3,PP(:,10:end,1)*1e-3);
